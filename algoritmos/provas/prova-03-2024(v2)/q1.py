'''Escreva um programa em Python que irá ler 3 números inteiros inseridos pelo usuário (X, Y, Z). Identifique qual é
...
1. ADICIONA O 3 AO NÚMERO 8 (3 VEZES) → 8 + 3 + 3 + 3 = 17 → NOVO MAIOR
